...
class TestEndpoints : public ::testing::Test {
 protected:
    ...
    static void setUpTestCase() {
        ...
        std::cout << "test\n";
        std::string postData = "grant_type=refresh_token&client_id=" + clientId + "&client_secret=" + clientSecret + "&refresh_token=" + refreshToken;
...
Spotify TestEndpoints::sharedApi;
